    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.municipalities.update', $municipality->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="form-group @error('municipio') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="municipio" value="{{old('municipio',$municipality->municipio)}}" placeholder="Municipio">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="province_id">
                                @foreach($provinces as $prov)
                                    @if($municipality->province_id  == $prov->id)
