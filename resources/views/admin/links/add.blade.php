    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.content.links.store')}}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group @error('url') has-error @enderror">
                            ...
                            <input type="text" data-model="link" class="form-control" value="{{ old('url') }}" name="url" placeholder="url">
                            <span class="error-container"></span>
                            @error('url')
                            <span class="help-block" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group @error('logo') has-error @enderror">
                            <label for="logo">Logo<small class="required"> *</small></label>
                            <input type="file" name="logo" accept="image/*" class="@error('logo') is-invalid @enderror">
                            <span class="error-container"></span>
                            @error('logo')
                            <span class="help-block" role="alert">
                                        <strong>{{ $message }}</strong>
