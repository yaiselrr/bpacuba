    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.content.atms.store')}}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" data-model="atm" maxlength="4" class="form-control" value="{{ old('codigo') }}" name="codigo" placeholder="Código">
                            <span class="error-container"></span>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="referencia">Referencia</label>
                            <input type="text" class="form-control" value="{{ old('referencia') }}" name="referencia" placeholder="Referencia">
                            <span class="error-container"></span>
                        </div>
                        <div class="form-group">
