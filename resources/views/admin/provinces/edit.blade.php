    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.provinces.update', $province->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="form-group @error('provincia') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="provincia" value="{{old('provincia',$province->provincia)}}" placeholder="provincia">
