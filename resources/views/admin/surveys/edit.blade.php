    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.content.surveys.update', $survey->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="form-group @error('estrellas') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="estrellas" value="{{old('estrellas',$survey->estrellas)}}" placeholder="Valoración">
                        ...
                        <div class="form-group @error('sugerencias') has-error @enderror">
                            ...
                            <textarea name="sugerencias" class="form-control @error('sugerencias') is-invalid @enderror"
                                        placeholder="Sugerencias">{{old('sugerencias',$survey->sugerencias)}}</textarea>
                            <span class="error-container"></span>
                            @error('sugerencias')
                            <span class="help-block" role="alert">
                                        <strong>{{ $message }}</strong>
