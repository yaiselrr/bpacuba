    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.content.consults.update', $consult->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="form-group @error('nombre') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="nombre" value="{{old('nombre',$consult->nombre)}}" placeholder="nombre">
                        ...
                        <div class="form-group @error('email') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="email" value="{{old('email',$consult->email)}}" placeholder="email">
                            <span class="error-container"></span>
                            @error('email')
                            <span class="help-block" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group @error('mensaje') has-error @enderror">
                            ...
                            <textarea name="mensaje" class="form-control @error('mensaje') is-invalid @enderror"
                                       placeholder="mensaje">{{old('mensaje',$consult->mensaje)}}</textarea>
                            @error('mensaje')
                            <span class="help-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
