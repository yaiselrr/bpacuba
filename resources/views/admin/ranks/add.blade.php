    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.ranks.store')}}">
                    @csrf
                    <div class="box-body">
                        <div class="form-group @error('cargo') has-error @enderror">
                            ...
                            <input type="text" class="form-control" value="{{ old('cargo') }}" name="cargo" placeholder="Cargo">
