    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <form id="form" role="form" method="post" action="{{route('admin.nomenclator.type-offices.store')}}">
                    @csrf
                    <div class="box-body">
                        <div class="form-group @error('tipo') has-error @enderror">
                            <label class="control-label" for="tipo">Tipo de oficina<small class="required"> *</small></label>
                            <input type="text" class="form-control" value="{{ old('tipo') }}" name="tipo" placeholder="Tipo de oficina">
